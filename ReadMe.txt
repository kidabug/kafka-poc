...
9.Open different terminal to start consumer which can listen to multiple topics...
...
10. To reset the topic  to initial state use below kafka-topic binary to change the retention policy to 1 sec, this will reset the topic in 1 second.
